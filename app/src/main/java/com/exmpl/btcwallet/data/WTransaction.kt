...
@Inject constructor(private val wallet: Wallet) {
    ...
    private var byteTransactions: MutableList<ByteArray>? = null
    ...
    private suspend fun createTrWFee(amount: Coin, address: Address, fee: Coin): Int {
        ...
        try {
            ...
            Log.d(com.exmpl.btcwallet.data.LOG_TAG, "Creating Transaction is invalid.")
            throw ex
        }
    ...
    private fun addOutput(toReceiver: Coin, receiver: Address, fee: Coin){
        ...
        val change = wallet.amount.value.minus(toReceiver).minus(fee)
